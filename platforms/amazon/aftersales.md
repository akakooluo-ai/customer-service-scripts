...
- 话术中的 `[变量]` 需要根据实际情况替换
- Amazon 要求 24 小时内回复客户消息
- A-to-Z 索赔要在 48 小时内响应，避免影响账号健康度
...
2. **主动解决**：在客户开启 A-to-Z 索赔前主动联系并解决问题
3. **遵守规则**：严禁好评返现、诱导评价等违规行为
4. **保留证据**：处理纠纷时保留聊天记录和图片证据
