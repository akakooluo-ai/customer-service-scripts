...
- 话术中的 `[变量]` 需要根据实际情况替换
- eBay 要求 24 小时内回复买家消息，超时会影响卖家评级
- 所有退款必须通过 eBay 或 PayPal 官方渠道处理
...
```
Hello! We offer a 30-day hassle-free return policy. To initiate a return: 1) Go to your Purchase History; 2) Select the item and click "Return this item"; 3) Choose your reason and ship it back. Once we receive the item, we'll process your refund within 2 business days. Let me know if you need help!
```
...
```
Hello! I sincerely apologize that the item didn't meet your expectations. I want to make this right. Please send me photos of the issue so I can better understand the problem. I can offer you: 1) Full refund with return; 2) Partial refund to keep the item; 3) Replacement item. Which option works best for you?
```
...
```
Hello! Thank you for your purchase. We hope you're happy with your item. If you're satisfied, we'd appreciate it if you could leave us positive feedback. Your feedback helps us maintain our Top Rated Seller status and helps other buyers. Thank you!
```
...
```
Hello! I'm very sorry to hear about the quality issue with your item. This is not up to our standards. Please send me photos of the defect. I'll immediately process a full refund - no need to return the item. We're also reviewing our quality control to prevent this from happening again. Thank you for bringing this to our attention!
```
...
1. **快速响应**：24 小时内回复，避免纠纷自动判买家胜诉
2. **提供选择**：给买家 2-3 个解决方案选择
3. **保留记录**：所有沟通通过 eBay 消息系统
4. **避免违规**：不要好评返现、威胁买家或系统外交易
5. **主动补偿**：适当提供优惠券或部分退款，挽回客户信任

---

## 注意事项

- ❌ 禁止好评返现（"Leave positive feedback and get $5 back"）
- ❌ 禁止威胁买家（"If you leave negative feedback, we will..."）
- ❌ 禁止系统外交易（"Pay via PayPal Friends & Family"）
- ✅ 所有沟通必须通过 eBay 消息系统
