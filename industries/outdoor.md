...
Tell us your adventure plans and we'll confirm if this is right for you! 🌲
```
...
**适用场景：** 客户询问装备尺码（背包、服装、鞋类）

```
Sizing guide for this item: 📏
Size [S/M/L]: Fits [Measurements/Weight range]
How to measure: [Measurement instructions]
Fit type: [Regular/Athletic/Relaxed]
Between sizes? Go [up/down] for [Layering/Comfort].
Pro tip: [Specific sizing advice for this product]
Share your measurements for a personalized recommendation! 👟
```
...
```
Comparing [Product A] vs [Product B]: ⚖️
[Product A]:
• Best for: [Use case]
• Pros: [Lighter/More durable/Better value]
• Weight: [Weight]

[Product B]:
• Best for: [Use case]
• Pros: [More features/Higher capacity]
• Weight: [Weight]

Our pick: [Recommendation based on common needs]
What's your priority - weight, durability, or features? 🎯
```
...
```
Your gear is shipping! 📦
Before your adventure, please:
✓ Inspect all seams and zippers
✓ Test all buckles and straps
✓ Set up/try on at home first
✓ Check all included accessories
Report any issues within [Days] days.
...
```
Care tips for your new gear: 🧹
After each use:
• [Cleaning step 1]
• [Cleaning step 2]
Storage: [Storage instructions]
Avoid: [Things to avoid]
Maintenance: [Periodic maintenance tips]
Proper care = longer gear life! ⛺
```
...
```
Complete your setup! 🎒
This [Product] pairs great with:
✓ [Accessory 1] - [Benefit] - [Price]
✓ [Accessory 2] - [Benefit] - [Price]
✓ [Accessory 3] - [Benefit] - [Price]
Bundle discount: Save [Amount] when you add these!
Essential for [Activity type]. Want us to add them? 🏕️
```
...
```
As an outdoor enthusiast, you've earned: 🏆
...
For your safety, please STOP using the gear immediately.
Send us:
1) Photos/video of the problem
2) When and how it occurred
3) Product tag/serial number
We'll provide:
✓ Free replacement, OR
✓ Professional repair, OR
✓ Full refund
Response within 24 hours! 🛡️
```
...
```
Our return policy for outdoor gear: 📋
Unused items: [Days]-day full refund
Tried once (indoor): Exchange or store credit
Used outdoors: Case-by-case review
Process:
1) Contact us with order number
2) We'll provide return label
3) Refund/exchange upon receipt
Gear must be clean and complete. Questions? 💙
```
...
Common repairs:
• Zipper replacement: [Price]
• Seam resealing: [Price]
• Buckle/strap repair: [Price]
• [Other repair]: [Price]
Turnaround: [Days] days
Warranty repairs: FREE
Send photos first - we'll quote before you ship! ⛺
```
...
```
Pro tips for your [Product]: 💡
Setup: [Setup tip]
In the field: [Usage tip]
Packing: [Packing tip]
Common mistake to avoid: [Mistake]
Video guide: [Link if available]
These tips come from experienced adventurers! 🏔️
```
...
Based on your [Previous purchase], you might love:
[Upgraded product]: 
• [Improvement 1]
• [Improvement 2]
• [Improvement 3]
...
1. **安全第一**：户外装备涉及安全，故障问题要快速响应
2. **专业术语**：使用专业表达提升信任，但要解释清楚
3. **场景匹配**：根据客户活动类型推荐合适装备
4. **保养指导**：主动分享保养技巧，延长装备寿命
