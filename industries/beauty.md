...
Questions about sensitivity? We're here to help! 💙
```
...
[Product A]: Best for [Skin type/Concern], focuses on [Key benefit].
[Product B]: Best for [Skin type/Concern], focuses on [Key benefit].
Price difference: [Comparison].
Our recommendation: Based on your [Concern], we suggest [Product].
Want a personalized recommendation? Share your skincare goals! 🎯
```
...
2) [Product 2] - [Benefit]
3) [Product 3] - [Benefit].
Set value: [Original price] → [Set price] (Save [Amount]!)
These products work together for [Combined benefit].
Perfect for starting a complete routine! ✨
```
...
```
First time using this product? Here's our advice: 🌸
Week 1: Use every other day to let skin adjust.
Week 2+: Increase to daily use if no irritation.
Normal reactions: [Slight tingling/Mild purging] may occur initially.
Stop if: Severe redness, burning, or swelling.
We're here to guide you through your skincare journey! 💙
```
...
```
As our valued customer, you qualify for: 💎
...
```
We're so sorry to hear about your reaction! 😔
Please immediately:
1) Stop using the product
2) Rinse affected area with cool water
3) See a doctor if symptoms persist.
Send us photos of the reaction and product batch number.
We'll provide: Full refund + [Compensation].
...
```
Results timeline for this product: ⏰
Week 1-2: Skin adjusts, may see [Initial changes].
Week 4-6: Noticeable [Expected results].
Week 8+: Full benefits visible.
Tips for better results:
✓ Use consistently
✓ Apply correct amount
✓ Pair with [Complementary product].
Skincare is a journey - we're here to support you! 🌸
```
...
**适用场景：** 客户收到有问题的产品（变质、漏液等）

```
We apologize for the product issue! 😔
Please send photos of:
1) The problem (texture/color/leak)
2) Batch number on packaging
3) Expiry date.
We'll immediately send: Replacement OR Full refund.
No need to return damaged product!
Plus [Discount] for your next order. We're truly sorry! 💙
```
...
```
Running low on your favorite? 💕
Reorder now and enjoy:
✓ [Discount]% loyalty discount
✓ Free [Sample/Gift] with purchase
✓ Priority shipping.
Pro tip: [Product] pairs great with [New product] for enhanced results!
Thank you for trusting us with your skincare! 🌟
```
...
💡 Tip 1: [Application technique]
💡 Tip 2: [Best time to use]
💡 Tip 3: [Storage advice]
💡 Tip 4: [Layering order in routine].
Many customers see better results with these tips!
Questions about your routine? We love helping! 💆‍♀️
```
...
2. **过敏优先**：过敏问题要快速响应，优先保障客户安全
3. **专业建议**：根据肤质给出专业推荐，不要夸大产品效果
4. **耐心引导**：护肤效果需要时间，引导客户正确期望
