...
**适用场景：** 客户询问尺码、不确定选哪个尺码

```
Hi! For sizing, please check our size chart in the product images. 📏 
Measurements: Bust: [Size] | Waist: [Size] | Hip: [Size] | Length: [Size]. 
This item runs [true to size/small/large]. 
If you're between sizes, we recommend sizing [up/down]. 
Need help? Send us your measurements (height, weight, bust, waist, hip) and we'll recommend the perfect size! 👗
```
...
Questions about the material? Ask away! 🧵
```
...
```
Available colors: [Color 1], [Color 2], [Color 3]. 🎨 
Please note: Colors may vary slightly due to screen settings. We've photographed the actual product! 
Current stock: [Color]: [Quantity] units. 
Popular choice: [Best-selling color]. 
Need color advice? Tell us your skin tone/style and we'll recommend! 💕
```
...
Casual look: Pair with [Item 1] + [Item 2]. 
Dressy look: Style with [Item 3] + [Item 4]. 
Perfect for: [Occasions]. 
Trending style: [Current trend]. 
Check our store for matching accessories! 
Need personalized styling advice? Share your style preferences! 💃
```
...
Best for body type: [Body type recommendations]. 
Model info: Height [Height], wearing size [Size]. 
This design is [Flattering feature]. 
Want to see how it looks? Check our customer photos in reviews! 
...
```
Order confirmed! 🎉 
Just double-checking: You ordered size [Size] in [Color]. 
Based on our size chart, this should fit: [Measurements]. 
If you need to change the size before shipping, let us know ASAP! 
...
```
Your order: [Product Name] in [Color], Size [Size]. 🎨 
Please note: The actual color may vary slightly from the photo due to lighting/screen settings. 
We've included the most accurate product photos. 
If the color doesn't match your expectations upon arrival, we offer easy returns! 💝
```
...
```
Packaging info: Your item will arrive folded/rolled to minimize shipping costs and environmental impact. 📦 
Some wrinkles are normal! Simply: 
1) Hang it up for 24 hours OR 
2) Steam/iron on low heat. 
It'll look perfect! We've packed it with care! 🌟
```
...
✓ [Discount/Bonus] 
✓ Priority shipping. 
We'll notify you when it ships! Thank you for your patience! 💕
```
...
Your specifications: 
Size: [Custom size] | Color: [Color] | Special requests: [Requests]. 
Production time: [Time] days. 
We'll send progress photos! 
Custom items are non-returnable unless defective. 
Questions during production? Contact us anytime! 🎨
```
...
```
Size doesn't fit? No worries! 👗 
We offer FREE size exchanges! 
Process: 
1) Request exchange in your order 
2) We'll send the new size 
3) Return the original (free label provided). 
Or get a full refund! 
Please keep tags attached. We want you to love it! 💝
```
...
```
Color not as expected? We understand! 🎨 
Lighting and screens can affect color perception. 
If you're not satisfied: 
1) Send us a photo 
2) We'll offer: Full refund OR Exchange for different color. 
...
```
We're very sorry about the quality issue! 😔 
Please send photos of: 
1) The defect 
2) Product tag. 
We'll immediately: Send replacement OR Full refund + keep the item. 
No return needed for defective items! 
Plus [Discount] for your next order. We apologize! 💙
```
...
```
Love your purchase and want styling tips? 💕 
This piece pairs beautifully with: [Suggestions]. 
Check our store for: 
✓ Matching accessories 
✓ Complementary items 
✓ Complete the look sets. 
Share your styled photos and tag us - we might feature you! 
Need personal styling advice? DM us! 👗
```
...
2. **真实描述**：材质、颜色、版型要如实描述，避免夸大
3. **视觉辅助**：配合尺码表图片、模特试穿图提升沟通效率
4. **快速换码**：尺码问题是最常见的售后问题，处理要快速高效
