...
• Return window: [Days] days from delivery
...
```
I'm sorry to hear you'd like to return your order! 😔
...
• Refund processed within [Days] days of receipt
...
```
I'm very sorry about the quality issue! 😔

Please send us:
1) Photos of the defect
2) Photo of the product label/tag
...
```
I apologize that the item doesn't match the description! 😔

Please provide:
• Photo of what you received
• What was different from the listing
...
This shouldn't have happened. We're sorry! 💙
```
...
• Lost: We'll file a claim and send a replacement or refund
• Damaged: Please send photos, we'll replace immediately
...
I understand your frustration, and I want to make this right.

Please share:
• What happened
• How we can improve
• What resolution you'd prefer

We take all feedback seriously and will:
1) Investigate the issue
2) Provide a solution within [Time]
...
We've reviewed your order and would like to make things right.
...
If you're satisfied with your order, we'd really appreciate a review. 
Your feedback helps other customers and supports our small business.

If there's anything that could be better, please let us know first - 
we want to make sure you're 100% happy!
...
2. **主动解决**：在客户投诉升级前主动提供解决方案
3. **真诚道歉**：出现问题时真诚道歉，不要推卸责任
4. **超出预期**：提供额外补偿（折扣、赠品），超出客户预期
